...
export const theme = {
  extend: {
    animation: {
      ...
      fadeInRightSlow1: 'fadeInRight 1.3s ease-out',
      fadeInRightSlow2: 'fadeInRight 1.6s ease-out',
      fadeInRightSlow3: 'fadeInRight 1.9s ease-out',
      fadeInRightSlow4: 'fadeInRight 2.1s ease-out',
      fadeInRightSlow5: 'fadeInRight 2.4s ease-out',
      fadeInRightSlow6: 'fadeInRight 2.7s ease-out',
